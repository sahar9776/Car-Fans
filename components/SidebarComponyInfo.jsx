    ...
    >
      <div className="relative w-full lg:w-[80%] h-auto mx-auto bg-white rounded-md p-10">
        ...
        <div className="w-full h-full flex flex-col-reverse lg:flex-row lg:gap-10 items-start lg:items-center">
          ...
          {/* image brand  */}
          <div className="w-full lg:max-w-[35%] h-auto mb-5 lg:mb-0 border-b-2 border-r-2 border-accent rounded-md">
            <img src={imageBrand} alt="" className="w-full h-auto rounded-md" />
          </div>
        </div>
      </div>
    </div>
